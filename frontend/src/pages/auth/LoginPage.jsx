    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 dot-grid">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-on-surface-variant text-body-sm">Sign in to your account</p>
        </div>
        ...
        <div className="bg-surface-container border border-outline-variant/30 rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-primary-container text-white font-bold rounded-xl hover:brightness-110 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          {/* Google OAuth placeholder — wire up with actual Google button */}
          <button
            onClick={() => {/* Google sign-in handled via google-auth-library on backend */}}
            className="w-full py-3 border border-outline-variant/30 rounded-xl text-on-surface font-medium hover:bg-surface-container-high transition-all flex items-center justify-center gap-3"
          >
